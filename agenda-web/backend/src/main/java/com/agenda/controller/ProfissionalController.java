...
public class ProfissionalController {
    ...
    // Corrigido: Adicionado "/categoria" para evitar conflito de rotas (Ambiguous Mapping)
    ...
    public ResponseEntity<?> atualizar(@PathVariable Long id,
        ...
        return repository.findById(id)
                .map(profissional -> {
                    ...
                    profissional.setCategoria(dados.getCategoria()); // Integrado: Atualizando a categoria também
